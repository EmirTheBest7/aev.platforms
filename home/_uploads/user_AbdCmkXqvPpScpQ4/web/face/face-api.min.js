! function (t, e) {
    ...
    var Xp = function (r) {
        ...
        //Yp = ["нормально", "счастье", "грусть", "злость", "ужас", "отвращение", "удивлен"],
        //Yp = ["нормально🙂 ", "счастье😄", "грусть😥", "злость😡", "ужас🤭", "отвращение🤢", "удивление😮"],
        Yp = ["нормально🙂", "щастя😄", "сум 😥", "злість😡", "жах🤭", "неприязнь🤢", "здивування😮"],
        Qp = function () {
            function t(n) {
                var r = this;
