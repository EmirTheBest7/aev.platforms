function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var exchange = "Bitfinex";
var watchlist = ['BTC', 'ETH', 'XRP', 'BCH', 'EOS', 'BTG', 'LTC', 'NEO', 'DASH', 'XMR', 'ETC', 'ZEC', 'DOGE', 'ADA'];
var socket;
...
const Watcher = ({ price, symbol, change, popupDelay, chartData }) => /*#__PURE__*/
React.createElement("a", { className: `App__dashboard-watcher ${change > 0 ? 'gain' : 'lost'}`,
  style: {
    animationDelay: popupDelay + 's' },

  target: "_blank",
  href: `https://www.cryptocompare.com/coins/${symbol.toLowerCase()}/overview/${symbol}` }, /*#__PURE__*/
...
React.createElement(Area, {
  ...
  fill: change > 0 ? '#63b556' : '#ff6939' })))), /*#__PURE__*/



React.createElement("h2", null, symbol), /*#__PURE__*/
React.createElement("h1", null, "$", price), /*#__PURE__*/
React.createElement("span", { className: "indicator" }), /*#__PURE__*/
...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "App__dashboard" },

      this.state.watcher.map((symbol, i) => /*#__PURE__*/
      React.createElement(Watcher, {
        ...
        popupDelay: .55 + i * .2,
        chartData: this.state.chartData[symbol] }))), /*#__PURE__*/



      React.createElement("span", null, "Current Exchange: ", exchange), /*#__PURE__*/
      React.createElement("span", null, "Data stream:", /*#__PURE__*/

      React.createElement("span", {
        style: { color: this.state.socket === 'On' > 0 ? '#ff6939' : '#63b556' } },
      this.state.socket)), /*#__PURE__*/


      React.createElement("span", null, "Data source: ", /*#__PURE__*/React.createElement("a", { href: "https://www.cryptocompare.com", target: "_blank" }, "CryptoCompare"))));
...
ReactDOM.render( /*#__PURE__*/React.createElement(App, null), document.getElementById('i-am-a-react-app'));