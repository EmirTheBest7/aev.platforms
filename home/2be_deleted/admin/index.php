...
<body onload="start()">
  ...
  <div class="desktop">
    ...
    <div class="start-menu">
      ...
      <div class="start-screen-scroll">
        <div class="start-screen">
          ...
          <a class="start-screen__tile start-screen__tile--large start-screen__tile--mail masonry-item" href="#"
            data-ss-colspan="2">
            <i class="fa fa-envelope"></i>
            <span>Mail</span>
          </a>
    ...
    <div class="taskbar">
      ...
      <a class="taskbar__item taskbar__item--notepad" href="#" data-window="custom">
        <i class="fa fa-pencil"></i>
      </a>

      <div class="taskbar__tray">
        <span class="taskbar__el" id="fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></span>

        <span class="taskbar__el" id="time"></span>
    ...
    <!-- Custom Window App -->
    <div class="window" data-window="custom"
      style="display:none;width:600px;height:300px;top:10%;left:30%;">
      <div class="window__titlebar">
        <div class="window__controls window__controls--left">
          <a class="window__icon" href="#"><i class="fa fa-pencil"></i></a>
      ...
      <div class="window__body">
        <div class="window__main p-0">
          <iframe src="https://emiraliev.com/editor/" frameBorder="0" style="width:100%; height:100%;"></iframe>
        </div>
      </div>
