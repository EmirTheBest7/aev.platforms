<?php
	...
	$swap_var = array(
		"{SITE_ADDR}" => "https://www.emiraliev.com",
		"{EMAIL_LOGO}" => "https://www.emiraliev.com/images/logo_emailer.png",
		"{EMAIL_TITLE}" => "Send custom HTML emails with a PHP script!",
		"{CUSTOM_URL}" => "https://www.emiraliev.com/web-dev/php/send-emails-with-php-from-localhost-with-sendmail",
        "{CUSTOM_IMG}" => "https://i1.wp.com/www.emiraliev.com/wp-content/uploads/2019/05/thumbnail_Send-emails-with-php-from-localhost-with-SendMail.png",
