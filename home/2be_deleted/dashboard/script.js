...
//------------------------------------------------------- Cookies - PS {Preloader}, {DarkMode}
function setCookie() {

  var now = new Date();
  now.setTime(now.getTime() + 5 * 3600 * 1000);
  document.cookie = "ps_pl=false; expires=" + now.toUTCString() + "; path=/";
...
/* CUSTOM ICONS, YOU CAN DELETE THEM */
var faL1 = {
  prefix: "fac",
  iconName: "l1",
  icon: [
...
(function ($) {
  $(function () {
    ...
    function updateContent() {
      ...
      document.getElementById("game_name_href").innerHTML = game_name_href[i];
