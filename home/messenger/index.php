...
<body>
	...
	<?php file_get_module('../timeline/header.php'); ?>
	...
	<section class="mainApp">
		...
		<?php } else {
			echo "
			<div class='rightPanel' style='background: rgb(18,18,18);'>
				<h3 style='margin: 0;position: absolute;top: 50%;left: 55%;border: 1px solid;padding: 0 20px;border-radius: 20px;'>
	...
	<section class="config">
		...
		<section class="configSect second">
			...
			<div class="information">
				<ul>
					<li>Phone Number: <span class="blue phone">(+420) 123 456 789</span></li>
