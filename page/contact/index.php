    ...
    <div id='browser'>
      ...
      <div id='content'>
        ...
        <div id='right'>
          <form method="POST" action="#">
            ...
            <input placeholder='Email' type='email' name="contact_email">
            <input placeholder='Subject' type='text' name="contact_subject">
            <textarea placeholder='Message' rows='4' name="contact_message"></textarea>
            <?php echo (isset($success)) ? "<p style='color: lime;'>".$success."</p>" : ''; ?>
      ...
      <svg class="fish" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g id="Artboard" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="square">
          ...
          <g xmlns="http://www.w3.org/2000/svg" id="Artboard" stroke="none" stroke-width="1" fill="none"
            fill-rule="evenodd">
            <g id="Group" transform="translate(-71.000000, 3.000000)" fill="#0f33ff">
              <g id="l-2"
                transform="translate(96.916890, 37.437926) rotate(-89.000000) translate(-96.916890, -37.437926) translate(60.416890, 13.437926)">
                <ellipse id="Oval" cx="36.5" cy="24" rx="16.5" ry="24" />
                <path
