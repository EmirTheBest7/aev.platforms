      ...
      <div class="view-container">
        ...
        <div class="bio">
          ...
          <div class="pre-bio">
            ...
            <div class="btn" onclick="javascript:location.href='https://t.me/pragueflow_chat/'"><i class="uil uil-telegram-alt"></i> Telegram</div>
          </div>
          ...
          <div id="content1" class="content">
            <div class="post">
                  ...
                  <div class="post__content">
                    ...
                    <p>Мы <strong>НЕ</strong> публикуем ссылки, <strong>НЕ</strong> открываем комментарии и ни при каких обстоятельствах <strong>НЕ</strong> сообщаем третьим лицам имя автора поста. Единственный способ связаться с автором поста - поставить лайк и дождаться, чтобы он написал вам самостоятельно.</p><br><br>
                    <p><strong>❗ Для публикации вашей записи, ваш пост <strong>ОБЯЗАТЕЛЬНО</strong> должен содержать <strong>ВСЕ ТРИ</strong> пункта:</strong></p>
                    <ul>
                    ...
                    <p><strong>❗ Публикация постов осуществляется через 12-36 часов с того момента, как вы прислали вашу запись через функцию "Предложить новость". Если вы предложили свою новость, но через какое-то время она пропала - это еще не значит, что она была удалена и не будет опубликована. Скорее всего она была поставлена на таймер и через определенное время появится в ленте паблика.</strong></p><br><br>
                    <p><strong>❗ В случае, если вы прислали пост через функцию "Предложить новость", но не прикрепили к нему картинку или фотографию, администрация паблика оставляет за собой право прикрепить к посту ваш аватар Вконтакте (актуальный или один из предыдущих). Если аватар на странице автора отсутствует или модератор сочтет это неуместным, пост будет отклонен.</strong></p><br><br>
                    <p><strong>❗ В нашем паблике <strong>ЗАПРЕЩЕНА</strong> любая реклама. За попытки разместить рекламные посты под видом постов для поиска новых знакомств - бессрочная блокировка.</strong></p><br><br>
                    <br><br> *** <br><br>
                    <p>Модератор оставляет за собой право отклонить вашу новость или заблокировать любого пользователя без указания причины.</p><br><br>
                    <p>Если вы хотите связаться с администрацией паблика, пришлите ваше сообщение через функцию "Предложить новость". Если это будет необходимо, администратор свяжется с вами через личные сообщение (если они, конечно, будут открыты на вашей странице).</p><br><br>
          ...
          <div id="content2" class="content">
            <div class="post">
                  ...
                  <div class="post__content">
                    ...
                    <p>Мы рады сообщить, что в настоящее время мы работаем над новым материалом, который скоро будет готов. Пожалуйста, проявите немного терпения, и скоро вы сможете наслаждаться свежим и увлекательным контентом.</p><br><br>
