...
function TextToImage(
    $text="hello world", $newline_after_letters=40,$font='./Roboto-Regular.ttf', $size=100,
    $rotate=0,$padding=10,$transparent=false, 
    $color=array('red'=>255,'grn'=>255,'blu'=>255), 
    $bg_color=array('red'=>0,'grn'=>0,'blu'=>255)) {
    ...
    if(!is_file($font)) { file_put_contents($font,file_get_contents('./Roboto-Regular.ttf')); }
...
TextToImage("This text is too long!");
